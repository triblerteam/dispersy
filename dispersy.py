        ...
        for message in messages:
            ...
            if not message.payload.lan_introduction_address == ("0.0.0.0", 0):
                ...
                if message.payload.lan_introduction_address == self._lan_address:
                    yield DropMessage(message, "invalid LAN introduction address [introducing myself] %s"%message.payload.lan_introduction_address)
                    continue
    ...
    def check_puncture_request(self, messages):
        for message in messages:
            ...
            if message.payload.lan_walker_address == self._lan_address:
                yield DropMessage(message, "invalid LAN walker address [puncture myself] %s"%(message.payload.lan_walker_address))
                continue
